...
def model_UNet_Lipid_sup_dist_Correction(inputLip_shape,inputCorr_shape,tLayer, regularizer, nFilters, nNeuron, nMLPlayer, drop) :          
    ...
    ## 5th stage, lipid contaminated spectra                         
    X1s5 = MaxPooling2D(pool_size=(2,1), strides=None, padding='same', data_format=None)(X1s4)
    
    # X1s5 = Conv2D(filters = 3*nFilters, kernel_size = (7,2), strides = 1, padding ='same',
    #                  data_format='channels_last',
    #                  kernel_initializer= initializers.he_normal(seed=None), 
    #                  bias_initializer='zeros')(X1s5)   
    # X1s5 = PReLU(shared_axes=[1, 2])(X1s5)
    
    # X1s5 = Conv2D(filters = 3*nFilters, kernel_size = (7,2), strides = 1, padding ='same',
    #                  data_format='channels_last',
    #                  kernel_initializer= initializers.he_normal(seed=None), 
    #                  bias_initializer='zeros')(X1s5)   
    # X1s5 = PReLU(#shared_axes=[1, 2]
    #                  )(X1s5)    
    ...
    ## 5th stage, lipid contaminated spectra                         
    X2s5 = MaxPooling2D(pool_size=(2,1), strides=None, padding='same', data_format=None)(X2s4)
    
    # X2s5 = Conv2D(filters = 3*nFilters, kernel_size = (7,2), strides = 1, padding ='same',
    #                  data_format='channels_last',
    #                  kernel_initializer= initializers.he_normal(seed=None), 
    #                  bias_initializer='zeros')(X2s5)   
    # X2s5 = PReLU(shared_axes=[1, 2])(X2s5)
    
    # X2s5 = Conv2D(filters = 3*nFilters, kernel_size = (7,2), strides = 1, padding ='same',
    #                  data_format='channels_last',
    #                  kernel_initializer= initializers.he_normal(seed=None), 
    #                  bias_initializer='zeros')(X2s5)   
    # X2s5 = PReLU(#shared_axes=[1, 2]
    #                  )(X2s5)    

    ##### mixing of encoded layers (from X1 and X2)
    # 6th stage mixing
    X1X2s5 = concatenate([X1s5,X2s5], axis = 3)
    X1X2s5 = Dropout(drop)(X1X2s5) 
    X1X2s5 = Conv2D(filters = 3*nFilters, kernel_size = (7,2), strides = 1, padding ='same',
                     data_format='channels_last',
                     kernel_initializer= initializers.he_normal(seed=None), 
                     bias_initializer='zeros')(X1X2s5)
    X1X2s5 = PReLU()(X1X2s5)
    ...
    #s5 = UpSampling2D(size = (2,1))(X1X2s5)
    #s5 = concatenate([X2s5,X1X2s5], axis = 3)
    s5 = concatenate([X1s5,X2s5,X1X2s5], axis = 3)
    s5 = Dropout(drop)(s5)
    ...
    #s6 = concatenate([X2s4, s6], axis = 3)
    s6 = concatenate([X1s4, X2s4, s6], axis = 3)
    s6 = Dropout(drop)(s6)
    ...
    #s7 = concatenate([X2s3,s7], axis = 3)
    s7 = concatenate([X1s3,X2s3,s7], axis = 3)
    s7 = Dropout(drop)(s7)
    ...
    s8 = UpSampling2D(size = (2,1))(s7)
    #s8 = concatenate([X2s2,s8], axis = 3)
    s8 = concatenate([X1s2,X2s2,s8], axis = 3)
    s8 = Dropout(drop)(s8)
    s8 = Conv2D(int(2*nFilters), kernel_size = (7,2), padding = 'same', kernel_initializer = 'he_normal')(s8)
    s8 = PReLU(shared_axes=[1, 2])(s8)
    s8 = Conv2D(int(2*nFilters), kernel_size = (7,2), padding = 'same', kernel_initializer = 'he_normal')(s8)
    s8 = PReLU(#shared_axes=[1, 2]
                      )(s8) 
    
    s9 = UpSampling2D(size = (2,1))(s8)
    s9 = Dropout(drop)(s9)
    #s9 = concatenate([X2s1,s9], axis = 3)#add X2_input
    #s9 = concatenate([X2s1, X2_input, s9], axis = 3)#add X2_input
    s9 = concatenate([X1s1, X1_input, X2s1, X2_input, s9], axis = 3)#add X2_input
    # s9 = Conv2D(int(2*nFilters), kernel_size = (7,2), padding = 'same', kernel_initializer = 'he_normal')(s9)
    # s9 = PReLU(shared_axes=[1, 2])(s9)
    # s9 = Conv2D(int(2*nFilters), kernel_size = (7,2), padding = 'same', kernel_initializer = 'he_normal')(s9)
    # s9 = PReLU(#shared_axes=[1, 2]
    #                   )(s9)

    s9 = Conv2D(int(2*nFilters), kernel_size = (1,2), padding = 'valid', kernel_initializer = 'he_normal')(s9)
    s9 = PReLU(shared_axes=[1, 2])(s9)   
    s9 = Conv2D(int(2*nFilters), kernel_size = (1,1), padding = 'same', kernel_initializer = 'he_normal')(s9)
    s9 = PReLU()(s9) 
                      
    s9 = Conv2D(1, 1, kernel_initializer = 'he_normal')(s9)
    Y = PReLU(shared_axes=[1, 2])(s9) 
...
def LinearModel(input_shape,output_shape,nFilters,  nNeuron, nMLPlayer, drop) : 
    X_input = Input(input_shape,)
    X = Conv2D(filters = 2*nFilters, kernel_size = (11,2), strides = 1, padding ='same',
                     data_format='channels_last',
                     kernel_initializer= initializers.he_normal(seed=None), 
                     bias_initializer='zeros')(X_input)
    X = Dropout(drop)(X)

    X = Conv2D(filters = 4*nFilters, kernel_size = (11,2), strides = 1, padding ='same',
                     data_format='channels_last',
                     kernel_initializer= initializers.he_normal(seed=None), 
                     bias_initializer='zeros')(X)
    X = Dropout(drop)(X)

    X = Conv2D(filters = 8*nFilters, kernel_size = (11,2), strides = 1, padding ='same',
                     data_format='channels_last',
                     kernel_initializer= initializers.he_normal(seed=None), 
                     bias_initializer='zeros')(X)
    X = Dropout(drop)(X)
    ...
    #                 kernel_initializer= initializers.he_normal(seed=None), 
    #                 bias_initializer='zeros')(X)
    X = Conv2D(filters = 2*nFilters, kernel_size = (1,1), strides = 1, padding ='same',
                     data_format='channels_last',
                     kernel_initializer= initializers.he_normal(seed=None), 
                     bias_initializer='zeros')(X)
    X = Flatten()(X)
    X = Dropout(drop)(X)
    #for i in range(nMLPlayer-1):
     #    X = Dense(nNeuron,kernel_initializer= initializers.glorot_normal(seed=0),  bias_initializer='zeros')(X)
      #   X = Dropout(drop)(X)
...
def DenseModel(input_shape,output_shape,nFilters,  nNeuron, nMLPlayer, drop) : 
    X_input = Input(input_shape,)
